        ...
        1: [function (a, b, c) {
            ...
            function f(a, b, c, d) {
                ...
                switch (c.orient()) {
                    ...
                    case"right":
                        a.attr({
                            x: d * (Math.max(c.innerTickSize(), 0) + c.tickPadding()),
                            y: g(b, e),
                            dy: ".32em"
            ...
            function i(a, b, c, d, e, f) {
                return function (g) {
                    ...
                    switch (b.orient()) {
                        ...
                        case"right":
                            var k = 0;
                            return e > c / 2 ? j = c / 2 : k = c / 2 - e, ["M", 0, i, "l", f * Math.max(b.innerTickSize(), 1), -j, "l", 0, -k, "l", f * d, 0, "l", 0, c, "l", f * -d, 0, "l", 0, -k].join(" ");
                        case"top":
                        case"bottom":
                            var l = 0;
            ...
            b.exports = function (a, b, c, g, h, i) {
                return function () {
                    function a(b) {
                        ...
                        c.exit().remove(), e.append("path").attr("class", "horizontal wire"), e.append("path").attr("class", "vertical wire"), h.annotation.append(e, o, "x"), h.annotation.append(e, p, "y"), b.selectAll("rect").data([0]).enter().append("rect").style({
                            fill: "none",
                            "pointer-events": "all"
                        }), a.refresh(b)
                    }
                    ...
                    return a.refresh = function (a) {
                        ...
                        g.attr({
                            ...
                            d(a, "none");
                            n.out();
                        }).on("touchmove", b(h, i, k, l)), j(h, i, k, l)
                ...
                return function () {
                    ...
                    function f() {
                        ...
                        return function (e) {
                            ...
                            var g = c(0), h = c(f) - g, i = b(a.d(e)) - d / 2;
                            return ["M", i, g, "l", 0, h, "l", d, 0, "l", 0, -h].join(" ")
                        }
                    }
